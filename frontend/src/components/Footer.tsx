    ...
    <footer className="bg-slate-50 border-t border-[#dadce0] pt-16 pb-8 mt-auto w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 mt-2">
              {/* GitHub */}
              <a href="https://github.com/dhyey0904" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1a73e8] transition-colors p-3 -m-3 inline-block">
              ...
              {/* LinkedIn */}
              <a href="https://linkedin.com" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1a73e8] transition-colors p-3 -m-3 inline-block">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              </a>
              {/* Twitter/X */}
              <a href="https://twitter.com" aria-label="Twitter" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1a73e8] transition-colors p-3 -m-3 inline-block">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li><Link href="/about" className="text-gray-500 hover:text-[#1a73e8] transition-colors text-base py-2 inline-block w-full">About Us</Link></li>
              <li><Link href="/privacy" className="text-gray-500 hover:text-[#1a73e8] transition-colors text-base py-2 inline-block w-full">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-gray-500 hover:text-[#1a73e8] transition-colors text-base py-2 inline-block w-full">Terms of Service</Link></li>
              <li><Link href="/report" className="text-gray-500 hover:text-[#1a73e8] transition-colors text-base py-2 inline-block w-full">Report Abuse</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col items-center gap-4">
          ...
          {/* Social Share Plugins for SEO */}
          <div className="flex flex-wrap items-center justify-center gap-4 mt-2">
            <span className="text-sm font-semibold text-gray-700">Share SnapLink:</span>
            <a href="https://twitter.com/intent/tweet?url=https://www.snaplinks.in&text=Check%20out%20SnapLink%20-%20The%20ultimate%20secure%20file%20sharing%20and%20URL%20shortening%20platform!" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 text-xs font-bold text-white bg-blue-400 hover:bg-blue-500 rounded-full transition-colors flex items-center gap-2">
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.snaplinks.in" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 text-xs font-bold text-white bg-[#1877F2] hover:bg-[#166FE5] rounded-full transition-colors flex items-center gap-2">
              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              Share on Facebook
            </a>
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://www.snaplinks.in" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 text-xs font-bold text-white bg-[#0A66C2] hover:bg-[#004182] rounded-full transition-colors flex items-center gap-2">
          ...
          <div className="text-center flex flex-col sm:flex-row items-center gap-2 sm:gap-6 text-sm text-gray-500">
            ...
            <p>
              Designed & Engineered by <a href="https://github.com/dhyey0904" target="_blank" rel="noopener noreferrer" className="font-semibold text-gray-700 hover:text-[#1a73e8] transition-colors">Dhyey Raja</a>
            </p>
          </div>
        </div>
      </div>
