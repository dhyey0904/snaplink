        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 mt-2">
              {/* GitHub */}
              <a href="https://github.com" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1a73e8] transition-colors p-3 -m-3 inline-block">
