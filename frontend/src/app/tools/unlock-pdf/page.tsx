  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      if (err.message?.includes("Invalid password") || err.message?.includes("encrypted")) {
         ...
         setErrorMsg("Error processing PDF. Ensure it is a valid PDF file.");
      }
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      <header className="bg-white shadow-sm py-6 px-8 flex justify-between items-center">
        ...
        <span className="bg-pink-100 text-pink-700 font-bold px-3 py-1 rounded-full text-xs">Free Tool</span>
      </header>
