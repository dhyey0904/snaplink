      ...
      <div className="max-w-md w-full p-8 bg-white rounded-xl shadow-lg text-center">
        ...
        <form onSubmit={handleUnlock} className="space-y-4">
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-black text-center text-gray-900 placeholder-gray-600"
          />
          <button
            type="submit"
