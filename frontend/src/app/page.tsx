                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 mb-8">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input id="bioNameInput" type="text" value={bioName} onChange={e => setBioName(e.target.value)} className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all text-gray-900" />
                    </div>
                    <div>
