            ...
            <div className={`absolute inset-0 rounded-3xl p-5 md:p-8 flex flex-col justify-between backface-hidden border`}
              ...
              <div className="relative z-10 flex items-end justify-between">
                <div className="flex flex-col">
                  ...
                  <p className={`text-xs md:text-base font-semibold uppercase tracking-widest mt-1 md:mt-2 ${isDarkText ? 'text-gray-700' : 'text-white/80'}`}>
                    {card.job_title || 'Job Title'}
                    {card.logo_url && card.company ? ` • ${card.company}` : ''}
                  </p>
