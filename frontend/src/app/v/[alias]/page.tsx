            ...
            <div className={`absolute inset-0 rounded-3xl p-5 md:p-8 flex flex-col justify-between backface-hidden border`}
              ...
              <div className="flex justify-between items-start relative z-10">
                <div className="flex items-center gap-3">
                  ...
                  {card.company && (
                    <div className={`font-bold tracking-widest text-xs md:text-base uppercase ${isDarkText ? 'text-gray-900' : 'text-white'}`}>{card.company}</div>
                  )}
                  {!card.logo_url && !card.company && (
                    <div className={`font-bold tracking-widest text-xs md:text-base uppercase ${isDarkText ? 'text-gray-900' : 'text-white'}`}>COMPANY</div>
                  )}
                </div>
