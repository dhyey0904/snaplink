          ...
          {tier === "free" ? (
            <div className="max-w-5xl mx-auto">
              <div className="mb-16 text-center">
                ...
                <p className="text-[#5f6368] text-xl mt-6 max-w-2xl mx-auto leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                  ...
                  <div>
                    ...
                    <ul className="space-y-4">
                      <li className="flex items-start text-[#5f6368]">
                        ...
                        <span><strong className="text-[#202124]">Bulk Operations:</strong> Perfect for high-volume automated workflows.</span>
                      </li>
                      <li className="flex items-start text-[#5f6368]">
                        <svg className="w-6 h-6 text-[#1a73e8] mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                      ...
                      <li className="flex items-start text-[#5f6368]">
                        <svg className="w-6 h-6 text-[#1a73e8] mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                        <span><strong className="text-[#202124]">Unified Access:</strong> One single token for URL Shortening, Bio Pages, Files, and vCards.</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-xl flex flex-col items-center justify-center text-center relative overflow-hidden">
                  ...
                  <div className="flex items-baseline justify-center mb-6">
                    ...
                    <span className="text-xl text-[#5f6368] ml-2">/ month</span>
                  </div>
                  <p className="text-[#5f6368] mb-8">One subscription unlocks API access for all 4 services (URLs, Bio Pages, Files, vCards). Cancel anytime.</p>
