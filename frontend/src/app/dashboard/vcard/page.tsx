  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#e8f0fe] rounded-3xl border border-blue-100 sticky top-24 overflow-hidden perspective-1000">
