              ...
              <div className="w-full max-w-[340px] mb-6 flex flex-col gap-3">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-1.5 flex gap-1 items-center">
                  ...
                  <button onClick={() => {
                    if (navigator.share) {
                      navigator.share({
                        title: 'My 3D Digital vCard',
                        text: 'Check out my 3D Digital vCard!',
                        url: fullUrl,
                      }).catch(console.error);
                    } else {
                      alert("Sharing is not supported on this device/browser.");
                    }
                  }} className="p-2 text-green-600 hover:bg-green-50 rounded-lg transition-colors" title="Share Link">
