...
export const metadata: Metadata = {
  ...
  description: "Share files up to 1GB securely with auto-destructing links and password protection. The ultimate ephemeral file transfer tool.",
  alternates: {
...
export default function Page() {
  return (
    <SEOLandingLayout 
      ...
      subtitle="Send files up to 1GB with military-grade privacy. Your files self-destruct after being downloaded, leaving no trace behind."
      InteractiveWidget={
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-2xl p-12 text-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer group relative overflow-hidden">
              ...
              <p className="text-gray-500">Up to 1GB. Files self-destruct automatically.</p>
      ...
      content={
        <>
            ...
            <h3>Share Large Files up to 1GB</h3>
            <p>Whether you\'re sending high-resolution photography, massive video renders, or extensive PDF reports, SnapLink handles it effortlessly. Upload files up to 1GB directly from your browser with lightning-fast speeds.</p>
